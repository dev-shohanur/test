  ...
  return (
    <div className='container my-[60px]'>
      <div className="flex items-center justify-between">
        <h2 className='text-[32px] leading-[68px] font-semibold text-[#363848]'>{sectionData.section}</h2>
        <p className='text-[#5F4BDB] text-[18px] font-semibold leading-[27px] font-normal font-sans sm:block hidden'>{sectionData.subTitle}</p>
      </div>
      <Slider {...settings} className="gap-4">
        {
          sectionData.featuredprofile.map((profile) =>
